...
public class D04_NestedIfElseif_Emeklilik2 {
    public static void main(String[] args) {
        ...
        if (yas<0){
            ...
            if (cinsiyet=='K'){
                System.out.println("emekli olamazsiniz, daha " + (60-yas) + " yil calisman gerekir");
            }else if (cinsiyet=='E'){
                System.out.println("emekli olamazsiniz, daha " + (65-yas) + " yil calisman gerekir");
            }else {
