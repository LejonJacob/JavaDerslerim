...
public class CDizelCorolla extends BCorolla {
    ...
    String yakit="C Dizel";
    String motor="C 1.4 Dizel";
    String renk="C Tanimlanmadi";
    ...
    public static void main(String[] args) {
        ...
        // B Corolla class'inda motor variable'i olmadigindan CTE verir
        ...
        System.out.println(arb3.uretumYeri); // A Deger atanmadi
