...
public class D02ReusableMethods {
    ...
    public static Map<Integer, String> ogrenciMapOlustur(){
        ...
        ogrenciMap.put(105,"Ayse-Tan-10-M-SOZ");
    ...
    public static List<String> istenenSubdekiOgrenclerListesiOlustur(Map<Integer, String> ogrenciMap, String sube) {
    ...
    public static List<String> bransdakiOgrenclerLitesiOlustur(Map<Integer, String> ogrenciMap, String brans) {
