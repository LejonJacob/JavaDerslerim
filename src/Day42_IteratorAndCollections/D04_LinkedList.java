...
public class D04_LinkedList {
    public static void main(String[] args) {
        ...
        /*
        Temel özelligi Linked olmasi (elementlerin birbirine bagli sekilde siralanmasidir)

        LinkList 3 interfaceyi implement etmistir
        1- List
        2- Deque
        3- Queue
        data turunu hangisinden secersek onun özelliklerini tasir.
         */
