...
public class Araba1 {
     ...
     */
    public Araba1(int ilnNo, String mrk, String mdl, int yl,int fyt){
        ilanNo=ilnNo;
        marka=mrk;
        model=mdl;
        yil=yl;
     ...
     */
    public Araba1(int ilanNo, String marka, String model, int yil) {
        this.ilanNo = ilanNo;
        this.marka = marka;
        this.model = model;
        this.yil = yil;
    }
    public Araba1(String marka, int ilanNo , String model, int yil, int fiyat){
        this.ilanNo=ilanNo;
        this.marka=marka;
        this.model=model;
        this.yil=yil;
