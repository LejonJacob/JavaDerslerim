...
public class D02_Maps2 {
    public static void main(String[] args) {
        ...
        // Ögrenci map'ini entry'lere ayirip sinif kontrolu yapmaliyiz
        Set<Map.Entry<Integer, String>> ogrenciMapiEntrySeti= ogrenciMap.entrySet();

        for (Map.Entry<Integer, String> entry: ogrenciMapiEntrySeti) {
