...
public class D06_TreeMap {
    public static void main(String[] args) {
        ...
        System.out.println(ornekMap.pollFirstEntry()); // a=3 silip getirir
        ...
        System.out.println(ornekMap.headMap("m")); // m'ye kadar olanlari getirir bize {b=5, k=2}
